...
SRCS+=$(KTOP)/compile/FILE_MANAGEMENT/autoconf.c
...
SRCS+=$(KTOP)/lib/uio.c
SRCS+=$(KTOP)/main/cv_info.c
SRCS+=$(KTOP)/main/file_management_info.c
SRCS+=$(KTOP)/main/lock2_info.c
SRCS+=$(KTOP)/main/main.c
SRCS+=$(KTOP)/main/menu.c
SRCS+=$(KTOP)/main/syscalls_info.c
SRCS+=$(KTOP)/main/wait_proc_info.c
